...
class TouchPanel():
	...
	def __init__(self):
		...
		self.cctSlider = FullHeightSlider(self.sliderPane, (10000, 1600),  3500, 100, "CCT",       row = 0, col = 0)
		self.intSlider = FullHeightSlider(self.sliderPane, (1900,     0),  1000, 25,   "Intensity", row = 0, col = 1)
